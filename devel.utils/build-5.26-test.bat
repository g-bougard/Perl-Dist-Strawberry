...
perl -Mblib ..\script\perldist_strawberry -job ..\share\64bit-5.26.2.1-test.pp -notest_core -notest_modules -perl_64bitint -beta=0 -nointeractive -norestorepoints -wixbin_dir="C:\Program Files (x86)\WiX Toolset v3.11\bin" -cpan_url="http://cpan.metacpan.org/"
